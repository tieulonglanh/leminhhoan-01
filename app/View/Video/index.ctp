                            ...
                            <div class="box-inner">
                                <div class="mm-iframe-fr-yt">
                                    <?php echo $this->Html->link(
                                        ...
                                        <img src="<?php echo $home_videos[0]['Video']['images'] ?>" alt="<?php echo '[Xôn xao] - ' . $home_videos[0]['Video']['name'] ?>" />
                            ...
                            <div class="box-inner">
                                <div class="mm-iframe-fr-yt">
                                    <?php echo $this->Html->link(
                                        ...
                                        <img src="<?php echo $home_videos[1]['Video']['images'] ?>" alt="[xôn xao] <?php echo $home_videos[1]['Video']['name']; ?>" />
                                        <div class="icon_play"></div>
                            ...
                            <div class="box-inner">
                                <div class="mm-iframe-fr-yt">
                                    <?php echo $this->Html->link(
                                        ...
                                        <img src="<?php echo $home_videos[2]['Video']['images'] ?>" alt="[xôn xao] <?php echo $home_videos[2]['Video']['name']; ?>" />
                                        <div class="icon_play"></div>
