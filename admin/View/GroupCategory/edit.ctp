...
<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'group_category/edit', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
    ...
    <div class="row">
        <div class="col-xs-12">
                ...
                <div class="box-tools">
                    <div class="input-group">
                        <div class="input-group-btn">
                            ...
                            <a href="<?php echo DOMAINAD; ?>group_category" class="btn btn-sm btn-success"><i class="fa fa-fw fa-times"></i> Hủy </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <?php echo $this->Form->input('GroupCategory.id', array('type' => 'hidden')); ?>
                    <div class="form-group">
                        <?php echo $this->Form->input('GroupCategory.name', array('label' => 'Tên danh mục Content', 'class' => 'form-control', 'onchange' => 'get_alias()', 'id' => 'idtitle')); ?>
                    </div>
