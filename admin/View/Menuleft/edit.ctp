...
?>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'menuleft/edit', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
 ...
 -->
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->input('Menuleft.id',array('type'=>'hidden'));?>
