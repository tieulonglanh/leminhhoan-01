        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'gallery_category/edit', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->input('GalleryCategory.id',array('type'=>'hidden'));?>
