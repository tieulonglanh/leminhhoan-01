    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                    <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'gallery/search', 'type' => 'post', 'name' => 'frm_search')); ?>
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                    ...
                    <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'gallery/action_all', 'type' => 'post', 'name' => 'frm_list')); ?>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <th width="20%" style="text-align:center;"><?php echo $this->Paginator->sort('Gallery.name', 'Tên Album'); ?></th>
                        <th width="20%"><?php echo $this->Paginator->sort('Gallery.gallery_category_id', 'Danh mục'); ?></th>
                        <th width="11%"><?php echo $this->Paginator->sort('Gallery.sort_order', 'Sắp xếp'); ?></th>
                        <th width="11%"><?php echo $this->Paginator->sort('Gallery.modified', 'Thay đổi'); ?></th>
                        <th width="12%">Xử lý</th>
                        <th width="3%"><?php echo $this->Paginator->sort('Gallery.id', 'Mã'); ?></th>
                        </thead>

                        <?php foreach ($gallery as $key => $value) {  ?>
                            <tr>
                                <td><input type="checkbox" name="chose_active[<?php echo $value['Gallery']['id']; ?>]" /></td>
                                <td><?php echo $key+1; ?></td>
                                <td>
                                    <img src="<?php echo DOMAINAD?>/timthumb.php?src=<?php echo $value['Gallery']['images'];?>&amp;h=100&amp;w=100&amp;zc=1" />
                                </td>
                                <td><a href="<?php echo DOMAINAD ?>gallery/edit/<?php echo $value['Gallery']['id']; ?>" title="Edit"><?php echo $value['Gallery']['name']; ?></a>  <?php if(date('Y-m-d', strtotime($value['Gallery']['modified'])) == date('Y-m-d')) { ?><img src="<?php echo DOMAINAD ?>images/icons/iconnew.gif" alt="New" /><?php } ?></td>
                                <td style="text-align:center;"><?php echo $value['GalleryCategory']['name']; ?></td>
                                <td style="text-align:center;"><?php echo $value['Gallery']['sort_order']; ?></td>
                                <td>
                                    <?php echo date('d-m-Y', strtotime($value['Gallery']['modified'])); ?></td>
                                <td>
                                    <a href="<?php echo DOMAINAD ?>gallery/copy/<?php echo $value['Gallery']['id']; ?>" title="Copy"><img src="<?php echo DOMAINAD ?>images/icons/copy.png" alt="Copy" /></a>
                                    <a href="<?php echo DOMAINAD ?>gallery/edit/<?php echo $value['Gallery']['id']; ?>" title="Edit"><img src="<?php echo DOMAINAD ?>images/icons/pencil.png" alt="Edit" /></a> <a href="javascript:confirmDelete('<?php echo DOMAINAD ?>gallery/delete/<?php echo $value['Gallery']['id']; ?>')" title="Delete"><img src="<?php echo DOMAINAD ?>images/icons/cross.png" alt="Delete" /></a>
                                    <?php
