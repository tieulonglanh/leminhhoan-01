<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo DOMAINAD ?>right" > Right</a></li>
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <!-- box-header -->
            <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'right/add', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('Right.images',array('label'=>false, 'class'=>'form-control','id' => 'xFilePath','maxlength'=>'255'));?>
