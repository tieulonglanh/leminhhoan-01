<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo DOMAINAD ?>Right_category" > Right</a></li>
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <!-- box-header -->
            <?php echo $this->Form->create(null, array('url' => DOMAINAD . 'Right_category/add', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
                ...
                <div class="box-tools" style="margin-bottom: 10px">
                    <div class="input-group">
                        <div class="input-group-btn">
                            ...
                            <a href="<?php echo DOMAINAD; ?>Right_category" class="btn btn-success"><i class="fa fa-fw fa-times"></i> Hủy</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box box-primary">
                <div class="box-body">
                   ...
                   <!--  <div class="form-group">
                        <?php echo $this->Form->input('RightCategory.parent_id',array('type'=>'select','options'=>$list_cat,'empty'=>'Chọn danh mục','class'=>'form-control','label'=>''));?>
                    </div> -->
